  ...
  var win = void 0,
    raf =
      (win =
        'undefined' != typeof window
          ? window
          : 'undefined' != typeof self ? self : {}).requestAnimationFrame ||
  ...
  function createIntervalTree(intervals) {
    ...
    for (i = 0; i < intervals.length; ++i) {
      ...
      s[1] < mid
        ...
        : mid < s[0] ? rightIntervals.push(s) : centerIntervals.push(s);
    }
  ...
  var _initialiseProps = function() {
    ...
    (this.state = {
      ...
      (this._rowHeightBottomGrid = function(_ref8) {
        ...
        return _state5.showVerticalScrollbar &&
          ...
          value: function() {
            if (this.Grid) {
              var _Grid = ReactDOM.findDOMNode(this.Grid),
                clientWidth = (_Grid && _Grid.clientWidth) || 0,
                scrollbarWidth =
                  ((_Grid && _Grid.offsetWidth) || 0) - clientWidth;
              this.setState({
                scrollbarWidth: scrollbarWidth,
              });
            }
