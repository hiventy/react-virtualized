...
describe('Grid', function () {
  ...
  describe('overscanColumnCount & overscanRowCount', function () {
    ...
    it('should set the correct scroll direction', function () {
      ...
      expect(grid.state.scrollDirectionHorizontal).toEqual(_getOverscanIndices.SCROLL_DIRECTION_FORWARD);
      expect(grid.state.scrollDirectionVertical).toEqual(_getOverscanIndices.SCROLL_DIRECTION_FORWARD);
      ...
      expect(grid.state.scrollDirectionHorizontal).toEqual(_getOverscanIndices.SCROLL_DIRECTION_BACKWARD);
      expect(grid.state.scrollDirectionVertical).toEqual(_getOverscanIndices.SCROLL_DIRECTION_BACKWARD);
    ...
    it('should overscan in the direction being scrolled', function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(done) {
  ...
  it('should pass the cellRenderer an :isScrolling flag when scrolling is in progress', function () {
    var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(done) {
  ...
  describe('cell caching', function () {
    ...
    it('should support a custom :scrollingResetTimeInterval prop', function () {
      var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(done) {
  ...
  describe('recomputeGridSize', function () {
    it('should recompute cell sizes and other values when called', function () {
      var columnIndices = [];
      var rowIndices = [];
      function columnWidth(_ref14) {
        var index = _ref14.index;

        columnIndices.push(index);
        return 10;
      }
      function rowHeight(_ref15) {
  ...
  describe('pure', function () {
    ...
    it('should not re-render grid components if they shallowCompare style', function () {
    ...
    it('should clear all but the visible rows from the style cache once :isScrolling is false', function () {
      var _ref17 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(done) {
        var props, grid;
  ...
  it('should not pull from the style cache while scrolling if there is an offset adjustment', function () {
    ...
    var grid = (0, _TestUtils.render)(getMarkup({
      ...
      scrollTop: _ScalingCellSizeAndPositionManager.DEFAULT_MAX_SCROLL_SIZE
    }));

    simulateScroll({
      grid: grid,
      scrollTop: _ScalingCellSizeAndPositionManager.DEFAULT_MAX_SCROLL_SIZE + 100
    });
