...
var Grid = function (_Component) {
  ...
  _createClass(Grid, [{
    ...
    value: function _debounceScrollEnded() {
      ...
      if (!this._scrollLoop) {
        (function () {
          _this5._scrollLoop = true;
          var loop = function loop() {
            var now = window.performance.now();
            if (_this5._lastScroll && now - _this5._lastScroll >= scrollingResetTimeInterval) {
              _this5._scrollLoop = false;
              _this5._debounceScrollEndedCallback();
            } else {
